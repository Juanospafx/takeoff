...
test('dashboard and editor bypass the previous cached Takeoff scripts', () => {
    assert.match(dashboard, /project_takeoff\.js\?v=takeoff-group-persistence-20260821-1/);
    assert.match(page, /editor\/takeoff\.js\?v=takeoff-group-persistence-20260821-1/);
});
